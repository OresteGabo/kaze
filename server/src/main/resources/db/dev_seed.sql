...
INSERT INTO venue_reservations (id, reservation_code, requester_user_id, place_id, service_id, event_id, event_name, preferred_date_label, selected_room_label, guest_count, package_label, add_ons, payment_method, note, status, created_at, updated_at) VALUES
    ('reservation_product_night', 'KAZE-PRODUCT1', 'user_ange_uwase', 'rw-kgl-marriott', 'svc_marriott_boardroom', 'event_product_night', 'Kigali Product Night', '25 Apr 2026 evening', 'Nyarutarama Boardroom', 120, 'Evening launch package', ARRAY['Conference photography','Delegate arrival and wayfinding']::TEXT[], 'Pay deposit after venue confirmation', 'Need a quiet registration point and sponsor table near the room entrance.', 'PENDING_CONFIRMATION', '2026-04-22 09:15:00+00', '2026-04-22 09:15:00+00'),
    ('reservation_umucyo_wedding', 'KAZE-UMUCYO1', 'user_david_k', 'rw-rebero-umucyo-gardens', 'svc_umucyo_garden', 'event_umucyo_wedding', 'Umutoni & Karemera Wedding Weekend', '26 Apr 2026 afternoon', NULL, 450, 'Garden ceremony and reception', ARRAY['Photo and film package','Wedding Guest Shuttle']::TEXT[], 'Venue invoice', 'Family arrival should separate elders, vendors, and general guests.', 'CONFIRMED', '2026-04-18 12:30:00+00', '2026-04-20 08:45:00+00'),
    ('reservation_women_trade', 'KAZE-WITA261', 'user_grace_u', 'rw-kigali-intare-arena', 'svc_intare_mainhall', 'event_women_in_trade', 'Women In Trade Africa 2026', '8 May 2026 full day', 'Main hall', 1200, 'Main hall conference package', ARRAY['Hybrid streaming production','Delegate arrival and wayfinding']::TEXT[], 'Pay deposit after venue confirmation', 'Need speaker green room, media table, and two registration flows.', 'PENDING_CONFIRMATION', '2026-04-24 10:05:00+00', '2026-04-24 10:05:00+00');
