...
internal enum class SettingsDetailPage(
    ...
    PAYMENTS(
        ...
        summary = "How venue approval and booking status are confirmed.",
        icon = Icons.Default.Payments,
        tokens = listOf("Approval", "Reservation code", "Venue review"),
        sections = listOf(
            LegalSection("Reservation code", listOf("A submitted request returns a confirmation code so the user can identify it later.")),
            LegalSection("Venue review", listOf("The venue confirms availability before the booking is treated as approved.")),
            LegalSection("Payment timing", listOf("Some reservations may be confirmed by the venue before payment is requested or collected.")),
        ),
    ),
    SAVED_PLACES(
        title = "Saved places",
        summary = "Favorite venues, hotels, and recently viewed spaces.",
        icon = Icons.Default.Bookmark,
        tokens = listOf("Favorite venues", "Saved hotels", "Recently viewed"),
        sections = listOf(
            LegalSection("Favorites", listOf("Save wedding venues, conference rooms, and hotels you want to compare.")),
            ...
            LegalSection("Collections", listOf("Group saved places into shortlists such as Wedding options, Conference rooms, and Hotel stays.")),
        ),
    ),
    INVITATIONS(
        title = "Invitations",
    ...
    HELP(
        ...
        sections = listOf(
            ...
            LegalSection("Where do I see my saved places?", listOf("Open Settings, then Activity, then Saved places.")),
            ...
            LegalSection("How can a hotel or venue join Kaze?", listOf("Venue owners and managers can contact Kaze support to add spaces, photos, prices, maps, and booking rules.")),
            ...
            LegalSection("Can I use Kaze without a hotel stay?", listOf("Yes. Kaze can also be used for venue reservations, invitations, event schedules, and access passes.")),
            ...
            LegalSection("Can Kaze support other venues?", listOf("Yes. Kaze is designed for conference rooms, wedding venues, hotels, and other event spaces.")),
            LegalSection("Can a business request a custom Kaze setup?", listOf("Yes. Businesses can contact Kaze support to discuss custom venue, event, or service needs.")),
            LegalSection("Report a problem", listOf("Report incorrect venue information, reservation issues, invitation errors, or app crashes.")),
            LegalSection("Contact", listOf("Contact support at dev@kazerwanda.com.")),
        ),
    ),
    ABOUT(
        title = "About Kaze",
        ...
        sections = listOf(
            ...
            LegalSection("Built by", listOf("Kaze is built by GABO to support events, venues, guests, and connected services.")),
            LegalSection("Contact", listOf("Website: https://kazerwanda.com", "Email: dev@kazerwanda.com")),
        ),
    ),
}
