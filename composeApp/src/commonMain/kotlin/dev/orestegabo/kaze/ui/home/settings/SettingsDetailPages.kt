...
internal enum class SettingsDetailPage(
    ...
    HELP(
        ...
        sections = listOf(
            LegalSection("FAQ", listOf("Find answers about invitation codes, Kaze Pass, venue searches, hotel stays, payments, and map navigation.")),
    ...
    ABOUT(
        title = "About Kaze",
        summary = "Product information, owner details, version, and website.",
        icon = Icons.Default.Info,
        tokens = listOf("Kaze by GABO", "Version 1.0", "orestegabo.dev"),
        sections = listOf(
            LegalSection("Product", listOf("Kaze is a digital hospitality and venue platform for stays, invitations, maps, event access, venue discovery, and service requests.")),
            LegalSection("Owner", listOf("Kaze is developed by GABO as a private commercial project.")),
