...
internal enum class SettingsDetailPage(
    ...
    PAYMENTS(
        ...
        sections = listOf(
            ...
            LegalSection("MVP scope", listOf("Direct in-app payments are deferred until after the reservation loop is stable.")),
        ),
    ),
    SAVED_PLACES(
        title = "Saved places",
    ...
    HELP(
        ...
        sections = listOf(
            ...
            LegalSection("How can a hotel or venue join Kaze?", listOf("Contact GABO at dev@kazerwanda.com or visit kazerwanda.com to discuss onboarding.")),
            ...
            LegalSection("Can Kaze support other venues?", listOf("Yes. The MVP focuses on conference rooms, wedding venues, and hotels.")),
